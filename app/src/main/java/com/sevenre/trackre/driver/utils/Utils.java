...
public class Utils {
	...
	public static final String STATUS_CHANGED_INTENT = "com.sevenre.trackre.driver.STATUS_CHANGE";
	public static final String STATUS = "status";
	
	// Shared Preference
	public static final String PREFERENCE = "com.sevenre.trackre.driver.pref";
	public static final String VEHICLE_ID = "com.sevenre.trackre.driver.pref.vehicleId";
	public static final String VEHICLE_NO = "com.sevenre.trackre.driver.pref.vehicleNo";
	public static final String TRIP_ID = "com.sevenre.trackre.driver.pref.tripId";
	public static final String SCHOOL_ID = "com.sevenre.trackre.driver.pref.schoolId";
	public static final String TRIP_STATUS = "com.sevenre.trackre.driver.pref.tripStatus";
	public static final String ERROR = "error";
	public static final String CUSTOMER_NO = "com.sevenre.trackre.driver.pref.customerno";
	public static final String SERVER_MOBILE_NUMBER = "com.sevenre.trackre.driver.pref.servermobilenumber";
	public static final String PASS_CODE = "com.sevenre.trackre.driver.pref.passcode";
	public static final String SCHOOL_INFO = "com.sevenre.trackre.driver.pref.schoolinfo";
	public static final String DRIVER_ID = "com.sevenre.trackre.driver.pref.driverid";
